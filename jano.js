...
//////////////////
jano91.on("ready", () => {
  var join = jano91.channels.get("911949952157118524"); /// id voice
  if (join) join.join();
});
//////////////////
jano92.on("ready", () => {
...
/////////////////////
jano100.on("ready", () => {
  var join = jano100.channels.get("911949952157118524"); /// id voice
  if (join) join.join();
});
...
jano98.login("");
jano99.login("");
jano100.login("OTENzlwNJMONTQ1OTk5ODkyYZlgtA.uqaQLUjCwMx-8wG-kyWLWB-dmo");
